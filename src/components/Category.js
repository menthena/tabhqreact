...
var Category = React.createClass({
  ...
  render: function () {
    ...
    return (
        <div data-id={this.props.idKey} data-droppable="category" draggable="true" onDragStart={this.props.dragStart} onDragEnd={this.props.dragEnd} onMouseEnter={this.props.dragHover} style={{'pointer-events': 'all'}}>
