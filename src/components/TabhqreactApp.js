  ...
  render: function() {
    ...
    return (
      <div id='wrapper'>
        ...
        <Content sections={sections} onSectionScroll={this.handleSectionScroll} ref='content' />
      </div>
    );
  }
});
